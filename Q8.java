...
public class Q8 
{
    ...
    {
        float salario, salario_resultado;
        String salario_reajustado;
        System.out.print("Digite o salário mensal atual do funcionário: ");
        salario = leia.nextFloat();
        salario_resultado = salario * 1.22f;
        salario_reajustado = new DecimalFormat("#.00").format(salario_resultado);
